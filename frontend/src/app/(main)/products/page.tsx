    ...
    <>
      <div className="relative mx-2 md:mx-6 pt-28 flex flex-col gap-5">
        <div className="flex items-end gap-2">
          <div className="uppercase text-[40px] md:text-[70px] lg:text-[100px] leading-none">
            All Products
          </div>
          <div className="leading-none pb-1 md:pb-2 lg:pb-3 font-inconsolata text-lg">
        ...
        <div className="w-full flex justify-between items-center pt-2">
          ...
          <div className="flex gap-2">
            <SlidersHorizontal className="w-5"></SlidersHorizontal>
            <p className="uppercase">Filter & Sort</p>
          </div>
        </div>
