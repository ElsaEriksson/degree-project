...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [results] = yield db_1.default.query("SELECT * FROM Collections");
...
router.get("/collection-product-with-variants/:collectionName", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
